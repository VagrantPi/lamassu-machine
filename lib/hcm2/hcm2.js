...
Hcm2.prototype.hasRejectedDenominations = function hasRejectedDenominations (bills) {
...
Hcm2.prototype.cashCount = function cashCount () {
  ...
  .then(({ reply, result, rejected }) => {
    ...
    if (this.hasRejectedDenominations(accepted)) {
      return this.reject().then(() => ({ reply, accepted: [] }))
...
Hcm2.prototype.run = function run (cb, { recyclers, rejectedDenominations }) {
